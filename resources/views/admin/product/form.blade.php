    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
               ...
               {!! Form::select('location_id', $location, isset($product)?$product->location_id:null, ['class' => 'form-control']) !!}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="form-group">
               {!! Form::label('short_desc', 'Product Short Description') !!}
               {!! Form::text('short_desc', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('stock_inventory', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
