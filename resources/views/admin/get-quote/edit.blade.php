...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit GetQuote #{{ $getquote->id }}</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{ url('/admin/get-quote') }}">Back</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title" id="basic-layout-form">GetQuote Info</h4>
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::model($getquote, [
                            'method' => 'PATCH',
                            'url' => ['/admin/get-quote', $getquote->id],
                            'files' => true
                        ]) !!}

                        @include ('Admin.get-quote.form', ['submitButtonText' => 'Update'])
