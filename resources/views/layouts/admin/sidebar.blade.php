        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li class="{{ (request()->is('admin/location') || request()->is('admin/location/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('admin/location')}}"><i></i>
                            <span data-i18n="eCommerce">Location</span>
                        </a>
                    </li>

                    <li class="{{ (request()->is('admin/get-quote') || request()->is('admin/get-quote/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('admin/get-quote')}}"><i></i>
                            <span data-i18n="eCommerce">Get Quote</span>
                        </a>
                    </li>

                    <li class="{{ (request()->is('bulkorders/bulkorders') || request()->is('bulkorders/bulkorders/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('bulkorders/bulkorders')}}"><i></i>
                            <span data-i18n="eCommerce">Bulk Orders</span>
                        </a>
                    </li>
