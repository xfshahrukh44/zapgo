                                  ...
                                  <div class="col-4">
                                       <div class="form-group">
                                            ...
                                            <select name="search" id="" class="form-control">
                                                ...
                                                <option  value="{{ $items->id }}" <?php if($items->id==$_GET['search']){ echo 'selected';}?>>{{ $items->name }}</option>
                                                @endforeach
                                            </select>
                                       </div>
                                  </div>
                    ...
                    <div class="item">
                        <div class="main-center product_category">
                             <div class="purification">
                                  <a href="{{ route('shopDetail',['id'=>$items->id]) }}"><img src="{{ asset($items->image) }}" class="img-fluid" alt=""></a>
                             </div>
                             <div class="mid-slides">
                                <a href="{{ route('shopDetail',['id'=>$items->id]) }}"> <h3>{{ $items->product_title }}</h3></a>
         ...
         <div class="row">
              ...
              <div class="col-lg-7">
                   <div class="camera-back">
                       ...
                       <img src="{{ asset($section[5]->value) }}" class="img-fluid machine-img" alt="" data-aos="fade-up">
                   </div>
              </div>
         </div>
    </div>
...
<!-- scd model -->
<div class="modal fade" id="news-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <form action="{{ route('quoteStore') }} " method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <input type="email" name="email" class="form-control" placeholder="Email Name*" required="">
                            </div>
                            <div class="form-group col-12">
  ...
  <option value="3">Water Pumps</option> --}}
                               ...
                               <div class="quantity">
                                             ...
                                             <input name="quantity" type="text" class="quantity__input input-1 count" readonly="" value="0">
...
@foreach($randomproducts as $key => $items)
<div class="modal fade staticBackdrop" id="staticBackdrops-{{ $key }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
