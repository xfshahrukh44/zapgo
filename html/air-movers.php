...
<section class="rent-sec about-inner">
     <div class="container">
          <div class="row">
               <div class="col-lg-12">
                    <div class="equipment">
                         <h1><span class="d-block">Air Movers </span></h1>
                    </div>
               </div>
                    ...
                    <div class="list-products">
                         <ul>
                              <li class="click-li">
                                   ...
                                   <div class="menu-drop">
                                        <a href="dehumidifie.php"><i class="fa-solid fa-arrow-right"></i> Dehumidifie</a>
                                        <a href="air-purification.php"><i class="fa-solid fa-arrow-right"></i> Air Purification</a>
                                        <a href="air-movers.php"><i class="fa-solid fa-arrow-right"></i> Air Movers</a>
                                        <a href="water-pump.php"><i class="fa-solid fa-arrow-right"></i> Water Pumps</a>
                                   </div>
                              </li>
                              <li class="click-li">
                                   <a href="dehumidifie.php"><i class="fa-solid fa-arrow-right"></i> Dehumidifie </a>
                         ...
                         <div class="col-lg-4">
                              <div class="main-pro-details" data-aos="fade-down" data-aos-duration="2000">
                                        ...
                                        <div class="product-img owl-carousel owl-theme">
                                             <div class="item">
                                                  <div class="cleaner-img">
                                                       <a href="axil-fan.php">
                                                            <img src="images/prosucts-inner/7.png" class="img-fluid" alt="">
                                                       </a>
                                                  </div>
                                             </div>
                                        </div>
                                   ...
                                   <div class="dollar-btn">
                                        <a href="#" class="btn blue-custom">$ 35 <span class="d-block">Per Day</span></a>
                                        <a href="#" class="btn blue-custom">$ 145 <span class="d-block">Per Week</span></a>
                                        <a href="#" class="btn blue-custom">$ 438 <span class="d-block">Per Month</span></a>
                                   </div>
                                   ...
                                   <div class="add-btn">
                                        <button class="btn blue-custom">Add To Cart</button>
                                   </div>
                              </div>
                         </div>
                         <div class="col-lg-4">
                              <div class="main-pro-details" data-aos="fade-up" data-aos-duration="2000">
                                   <div class="img-slides">
                                        <div class="product-img owl-carousel owl-theme">
                                             <div class="item">
                                                  <div class="cleaner-img">
                                                       <a href="low-profile-air-mover.php">
                                                            <img src="images/prosucts-inner/10.png" class="img-fluid" alt="">
                                                       </a>
                                                  </div>
                                             </div>
                                        </div>
                                   ...
                                   <div class="dollar-btn">
                                        <a href="#" class="btn blue-custom">$ 33 <span class="d-block">Per Day</span></a>
                                        <a href="#" class="btn blue-custom">$ 134 <span class="d-block">Per Week</span></a>
                                        <a href="#" class="btn blue-custom">$ 405 <span class="d-block">Per Month</span></a>
                                   </div>
                                   <div class="review-star">
                                        <div class="side-star">
                                             <i class="fa-solid fa-star"></i>
                              ...
                              <div class="main-pro-details" data-aos="fade-down" data-aos-duration="2000">
                                   <div class="img-slides">
                                        <div class="product-img owl-carousel owl-theme">
                                             <div class="item">
                                                  <div class="cleaner-img">
                                                       <a href="carpet-blower.php">
                                                            <img src="images/prosucts-inner/14.png" class="img-fluid" alt="">
                                                       </a>
                                                  </div>
                                             </div>
                                        </div>
                                   ...
                                   <div class="dollar-btn">
                                        <a href="#" class="btn blue-custom">$ 35 <span class="d-block">Per Day</span></a>
                                        <a href="#" class="btn blue-custom">$ 70 <span class="d-block">Per Week</span></a>
                                        <a href="#" class="btn blue-custom">$ 150 <span class="d-block">Per Month</span></a>
                                   </div>
                                   <div class="review-star">
                                        <div class="side-star">
                                             <i class="fa-solid fa-star"></i>
