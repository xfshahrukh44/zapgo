...
<section class="rent-sec about-inner">
     <div class="container">
          <div class="row">
               <div class="col-lg-12">
                    <div class="equipment">
                         <h1><span class="d-block">Dehumidifie </span></h1>
                    </div>
               </div>
                         ...
                         <div class="col-lg-4">
                              <div class="main-pro-details" data-aos="fade-down" data-aos-duration="2000">
                                        ...
                                        <div class="product-img owl-carousel owl-theme">
                                             <div class="item">
                                                  <div class="cleaner-img">
                                                       <a href="commercial-dehumidifier.php">
                                   ...
                                   <div class="dollar-btn">
                                        <a href="#" class="btn blue-custom">$ 58 <span class="d-block">Per Day</span></a>
                                        <a href="#" class="btn blue-custom">$ 235 <span class="d-block">Per Week</span></a>
                                        <a href="#" class="btn blue-custom">$ 710 <span class="d-block">Per Month</span></a>
                                   </div>
                                   ...
                                   <div class="add-btn">
                                        <button type="button" class="btn blue-custom" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Add To Cart</button>
                                   </div>
                              </div>
                         </div>
                         <div class="col-lg-4">
                              <div class="main-pro-details" data-aos="fade-down" data-aos-duration="2000">
                                   <div class="img-slides">
                                        <div class="product-img owl-carousel owl-theme">
                                             <div class="item">
                                                  <div class="cleaner-img">
                                                       <a href="ton-portable-air-conditioner.php">
                                                            <h4>Coming Soon</h4>
                                                       </a>
                                                  </div>
                                             </div>
                                   ...
                                   <div class="card-plus">
                                        <div class="dehum">
                                             <a href="ton-portable-air-conditioner.php">
                                                  <h4>Ton Portable Air Conditioner</h4>
                                             </a>
                                        </div>
                                        <div class="quantity">
                                             <a href="#" class=" minus-1"><span>-</span></a>
                                   ...
                                   <div class="dollar-btn">
                                        <a href="#" class="btn blue-custom">$ 195 <span class="d-block">Per Day</span></a>
                                        <a href="#" class="btn blue-custom">$ 395 <span class="d-block">Per Week</span></a>
                                        <a href="#" class="btn blue-custom">$ 794 <span class="d-block">Per Month</span></a>
                                   </div>
                                   <div class="review-star">
                                        <div class="side-star">
                                             <i class="fa-solid fa-star"></i>
