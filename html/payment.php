                    ...
                    <div class="check-form-s">
                         ...
                         <div class="main-check-one">
                              <div class="order-check detail-check">
                                   ...
                                   <div class="f-left">
                                        <a href="checkout-page.php" class="edit-back">Edit <i
                         ...
                         <div class="main-check-one">
                              <div class="order-check detail-check">
                                   ...
                                   <div class="f-left">
                                        <a href="your-details.php" class="edit-back">Edit <i
                                                  class="fa-solid fa-pencil"></i></a>
                              ...
                              <div class="pickup-main">
                                   <div class="comp-order">
                                        ...
                                        <div class="info-comp">
                                             <h5>Harrison York</h5>
                                             <p><a href="tel:+132-182-4249">132-182-4249</a></p>
                                             <p><a href="mailto:qeni@mailinator.com">qeni@mailinator.com</a></p>
                                        </div>
                                   </div>
                                   <div class="comp-order">
                                        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="info-comp">
                                             <p>10005 Oakton Crossing Court, Oakton, VA, USA
                                                  Oakton, VA 22124</p>
                                        </div>
                                   </div>
                              </div>
                         ...
                         <div class="main-check-one">
                              <div class="order-check detail-check">
                                   ...
                                   <div class="f-left">
                                        <a href="how-to-get-your-order.php" class="edit-back">Edit <i
                                                  class="fa-solid fa-pencil"></i></a>
                              ...
                              <div class="pickup-main">
                                   <div class="comp-order">
                                        ...
                                        <div class="info-comp">
                                             <h5>In-Store Pickup</h5>
                                             <p>Zap Go RENTALS CAPITAL FC
                                                  113 EXECUTIVE DR
                                                  STERLING, VA 20166 9508</p>
                                        </div>
                                   </div>
                                   <div class="comp-order">
                                        <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             <path fill-rule="evenodd" clip-rule="evenodd"
                                                  d="M7 10h3v3a1 1 0 1 0 2 0V9a1 1 0 0 0-1-1H7a1 1 0 1 0 0 2Zm3 8c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8Zm0-18C4.486 0 0 4.486 0 10s4.486 10 10 10 10-4.486 10-10S15.514 0 10 0Z"
                                                  fill="#0B3E21"></path>
                                        </svg>
                                        <div class="info-comp">
                                             <h5>Pickup time</h5>
                                             <p>Nov 28, 2023 at 02:00 PM
                                             </p>
                                        </div>
                                   </div>
                                   <div class="comp-order">
                         ...
                         <div class="main-check-one">
                              ...
                              <!--<div class="pickup-main">-->
                                   ...
                                   <!--          </div>-->
                                   <!--          <div class="f-h">-->
                                   <!--               <p>Your phone number will only be used to contact you about this-->
                                   <!--                    order.</p>-->
                                   <!--          </div>-->
                                   ...
                                   <!--<div role="tabpanel" class="tab-pane fade" id="Videos">-->
                                            <div class="pickup-main">
                                             <div class="second-menu">
                                                  <p>Who will be receiving your order</p>
                                                  
                                                  <div class="tabs-sign">
                                   <ul id="myTabss" class="nav nav-pills nav-justified" role="tablist" data-tabs="tabs">
                                        ...
                                        <li>
                                             <a data-toggle="tab" href="#Videoe"> Someone else</a>
                                        </li>
                                        
                                   </ul>
                                        <p>
                                  Anyone taking possession of ZapGo Rentals equipment, you must be 18 years or older and provide valid Government/state issued identification.
                              </p>
                                   <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade" id="Videoe">
                                            <div class="pickup-main">
                                             <div class="second-menu">
                        <p>
Please provide that the relevant person: </p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAddress" fdprocessedid="83rau">
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputAddress" fdprocessedid="83rau">
                                                ...
                                                <div class="btn-last">
                                                                 <a href="optional-plans.php" class="btn blue-custom">Save
                                                                      and
                                                                      continue </a>
                                                            </div>
                         ...
                         <div class="main-check-one">
                              ...
                              <div class="pickup-main">
                                   <div class="f-left">
                                        <p>Your card won’t be charged until your rental start date.</p>
                                   </div>
                              </div>
                              <!--<div class="pickup-main">-->
                              <!--     <div class="f-left">-->
                              ...
                              <!--          </h6>-->
                              <!--          <h4>Error 16</h4>-->
                                        <!--<p>iframesbrweb.sunbeltrentalspayments.com</p>-->
                              <!--          <p>2023-11-28 18:17:17 UTC</p>-->
                              <!--     </div>-->
                              <!--     <div class="f-left pick_one">-->
                              <!--          <h5>What happened?-->
                              <!--          </h5>-->
                              <!--          <p>This request was blocked by our security service</p>-->
                              <!--          <p>2023-11-28 18:17:17 UTC</p>-->
                              <!--          <p class="para-small">Your IP: <span>182.188.41.55</span></p>-->
                              <!--          <p class="para-small">Proxy IP: <span>45.60.16.112</span> (ID 10969-100)</p>-->
                              <!--          <p class="para-small">Incident ID: <span>969001170433767838-786739898752769357</span></p>-->
                              <!--     </div>-->
                              <!--</div>-->
                         </div>
                    </div>
...
<!-- Modal -->
<div class="modal fade" id="make_select" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
